...
const About = () => {
  //
  return (
    <section className="w-full col-start-2 col-end-12 grid gap-[101px] pb-[101px] -mt-[72px] lgMob:-mt-24 lgMob:pb-[118px] lap:-my-[38px] lap:p-0 lap:z-10 lgLap:-my-[70px] lgLap:gap-[121px] lgDesk:max-w-maxContentWidth lgDesk:mx-auto">
      <AboutCard
