...
const Cta = () => {
  return (
    <section className="w-full col-start-1 col-end-13 bg-ctaBgImageMobLg bg-center bg-cover grid grid-cols-mob lgMob:grid-cols-tab xtraSmTab:bg-ctaBgImageTabLg smLap:grid-cols-lap">
